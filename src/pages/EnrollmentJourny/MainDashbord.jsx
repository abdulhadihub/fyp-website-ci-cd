    ...
    return (
        <div className='enrollment-dash sm:m-9 m-2'>
            <div className='sm:flex block sm:justify-between justify-center'>
                <div className='text-[25px] font-bold'>Hi Imran!</div>
                <div className='flex'>
                    <Dropdown
                        menu={{ items }}
                    >
                ...
                <TabPane
                    tab={
                        <div className={`${activeKey === "1" ? 'text-white' : "text-primary"} font-bold flex`}>
                            <div className='mx-3'>
                                <div className='text-[14px] my-3'>Predicted Documents</div>
                ...
                <TabPane
                    tab={
                        <div className={`${activeKey === "2" ? 'text-white' : "text-primary"} font-bold flex`}>
                            <div className='mx-3'>
                                <div className='text-[14px] my-3'>Total Patients</div>
                                <div className='flex justify-between'>
                                    <div className='flex items-center'>
                ...
                <TabPane
                    tab={
                        <div className={`${activeKey === "3" ? 'text-white' : "text-primary"} font-bold flex`}>
                            <div className='mx-3'>
                                <div className='text-[14px] my-3'>Patients This Year</div>
                                <div className='flex justify-between'>
                                    <div className='flex items-center'>
                ...
                <TabPane
                    tab={
                        <div className={`${activeKey === "4" ? 'text-white' : "text-primary"} font-bold flex`}>
                            <div className='mx-3'>
                                <div className='text-[14px] my-3'>ASD Patients</div>
                                <div className='flex justify-between'>
                                    <div className='flex items-center'>
